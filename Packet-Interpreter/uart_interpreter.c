    ...
    if (packet == 1)
    {
      if (erpaValid)
      {
        ...
        case 1: // SEQ
          ...
          break;
        case 2: // ADC
          printf(" \e[1m%s:\e[m %.03fv", erpaLabels[erpaIndex], intToVoltage(erpaValues[erpaIndex], 16, 5));
          break;
        case 3: // SWP
          ...
          break;
        case 4: // TEMP1
          printf("| \e[1m%s:\e[m %.03f°C", erpaLabels[erpaIndex], intToCelsius(erpaValues[erpaIndex], 12, 3));
          break;
        case 5: // TEMP2
          printf(" \e[1m%s:\e[m %.03f°C", erpaLabels[erpaIndex], intToCelsius(erpaValues[erpaIndex], 12, 3));
          break;
